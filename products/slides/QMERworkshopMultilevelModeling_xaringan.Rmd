...
* Example of a two level model

---
## QMER: What we do

* Support for Statistics and Project Management, and Workflow
...
* **ALL METHODS** simply the phenomenon the are used to study.
...
## Problems with Aggregation and Disaggregation 
